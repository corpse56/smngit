...
------------------------
ALTER TABLE ALPHANEXT..WPNAMELIST 
add CONSTRAINT FK_WPNAMELIST_PRODUCTS FOREIGN KEY (ID) REFERENCES ALPHANEXT..PRODUCTS(ID)
ALTER TABLE ALPHANEXT..CABLELIST 
add CONSTRAINT FK_CABLELIST_PRODUCTS FOREIGN KEY (ID) REFERENCES ALPHANEXT..PRODUCTS(ID)
ALTER TABLE ALPHANEXT..ZHGUTLIST 
add CONSTRAINT FK_ZHGUTLIST_PRODUCTS FOREIGN KEY (ID) REFERENCES ALPHANEXT..PRODUCTS(ID)
